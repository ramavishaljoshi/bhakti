...
export default function PhysicsMala({ malaSize, onBead, onUndo, resetSignal }: Props) {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      topSprite = makeBead(beadR * 2.3, dpr, "#ffd9a8", "#caa15f", "#6e3a1e", "rgba(106,176,255,0.9)");
    };
    resize();
    ...
    const draw = (t: number) => {
      ...
      glow.addColorStop(0, "rgba(86,67,180,0.20)");
      glow.addColorStop(1, "rgba(86,67,180,0)");
      ctx.fillStyle = glow;
